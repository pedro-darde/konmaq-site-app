...
interface FormSupplierProps {
  ...
  supplierAdd: AddedSupplier;
}
export default function FormSupplierEditComponent({
  handleSubmit,
  supplierAdd,
}: FormSupplierProps) {
  const [supplier, setSupplier] = useState<AddedSupplier>(supplierAdd);
  const [municipios, setMunicipios] = useState<Municipio[]>([]);

  useEffect(() => {
    console.log(supplier)
    handleChangeSelectState(supplier.country as number);
  }, []);
