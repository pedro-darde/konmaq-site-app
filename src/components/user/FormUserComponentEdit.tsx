...
import { FieldNamesUser, User, UserAdd } from "../../interfaces/User";
...
export default function FormUserComponentEdit({
  handleSubmit,
  userAdd,
}: FormUserProps) {
  const [user, setUser] = useState<UserAdd>(userAdd);
  const [municipios, setMunicipios] = useState<Municipio[]>([]);

  useEffect(() => {
    handleChangeSelectState(parseInt(user.country.toString()));
  }, []);
